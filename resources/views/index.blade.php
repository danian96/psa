		...
		<div id="wrapper">
				...
				<div class="container">
					...
					<ul class="top-links list-inline">
						...
						<li>
							...
							<a class="dropdown-toggle no-text-underline" data-toggle="dropdown" href="#"><img class="flag-lang" src="/images/flags/us.png" width="16" height="11" alt="lang" /> ENGLISH</a>
							<ul class="dropdown-langs dropdown-menu pull-right">
								<li><a tabindex="-1" href="#"><img class="flag-lang" src="/images/flags/us.png" width="16" height="11" alt="lang" /> ENGLISH</a></li>
								<li class="divider"></li>
								<li><a tabindex="-1" href="#"><img class="flag-lang" src="/images/flags/de.png" width="16" height="11" alt="lang" /> GERMAN</a></li>
								<li><a tabindex="-1" href="#"><img class="flag-lang" src="/images/flags/ru.png" width="16" height="11" alt="lang" /> RUSSIAN</a></li>
								<li><a tabindex="-1" href="#"><img class="flag-lang" src="/images/flags/it.png" width="16" height="11" alt="lang" /> ITALIAN</a></li>
							</ul>
				...
				<div class="fullwidthbanner" data-height="600" data-shadow="0" data-navigationStyle="preview2">
					<ul class="hide">
						...
						<li data-transition="parallaxtobottom" data-slotamount="7" data-masterspeed="600"  data-saveperformance="off"  data-title="Courses And Events">
							<!-- MAIN IMAGE -->
							<img src="/images/lightblue-min.jpg"  alt="cover image"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
							...
							<div class="tp-caption tp-fade"
								...
								data-endspeed="300"
								style="z-index: 4;">
									<img src="/images/slider_girl_2.png" alt="">
							</div>
						...
						<li data-transition="parallaxtotop" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" data-title="Education and Training">
							<!-- MAIN IMAGE -->
							<img src="/images/wall2.jpg" alt="cover image"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
							...
							<div class="tp-caption sfr fadeout"
								...
								data-endspeed="500"
								style="z-index: 5;">
								<img src="/images/slider_girl_1.png" alt="">
							</div>
			...
			<section>
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-4">
							<img class="img-responsive" src="/images/edu1-min.jpg" alt="img" />
						...
						<div class="col-sm-4">
							<img class="img-responsive" src="/images/edu2-min.jpg" alt="img" />
						...
						<div class="col-sm-4">
							<img class="img-responsive" src="/images/edu3-min.jpg" alt="img" />
				...
				<div class="container">
					...
					<div class="owl-carousel text-center owl-testimonial nomargin" data-plugin-options='{"singleItem": true, "autoPlay": 3500, "navigation": false, "pagination": true, "transitionStyle":"fade"}'>
						<div class="testimonial">
							<figure>
								<img class="rounded" src="/images/11-min.jpg" alt="" />
							</figure>
						...
						<div class="testimonial">
							<figure>
								<img class="rounded" src="/images/12-min.jpg" alt="" />
							</figure>
							<div class="testimonial-content nopadding">
			...
			<section>
				<div class="container text-center">
					...
					<div class="row text-left">
						...
						<div class="col-sm-8">
							<img src="/images/laptop.png" alt="product image" />
						</div>
			...
			<section id="reservation" class="alternate">
				<div class="container">
					...
					<form class="validate" action="/contact.php" method="post" data-success="Reservation sent! Thank you!" data-toastr-position="bottom-right">
						<div class="row">
							<div class="col-md-4">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<form class="validate" action="/newsletter.php" method="post" data-success="Subscribed! Thank you!" data-toastr-position="bottom-right">
